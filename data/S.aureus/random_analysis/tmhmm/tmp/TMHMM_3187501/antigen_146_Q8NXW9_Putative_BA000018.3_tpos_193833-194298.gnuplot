...
set arrow from 212,1.07 to 246,1.07 nohead lt 3 lw 10
set arrow from 247,1.09 to 269,1.09 nohead lt 1 lw 40
set arrow from 270,1.11 to 278,1.11 nohead lt 4 lw 10
...
set key below
set title "TMHMM posterior probabilities for antigen_146|Q8NXW9|Putative|BA000018.3|tpos:193833-194298"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_3187501/antigen_146_Q8NXW9_Putative_BA000018.3_tpos_193833-194298.eps"
plot "./TMHMM_3187501/antigen_146_Q8NXW9_Putative_BA000018.3_tpos_193833-194298.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
