...
set key below
set title "TMHMM posterior probabilities for antigen_91|Q6GIE0|Na(+)/H(+)|BA000018.3|tpos:209049-209205"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_3187501/antigen_91_Q6GIE0_Na(+)_H(+)_BA000018.3_tpos_209049-209205.eps"
plot "./TMHMM_3187501/antigen_91_Q6GIE0_Na(+)_H(+)_BA000018.3_tpos_209049-209205.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
