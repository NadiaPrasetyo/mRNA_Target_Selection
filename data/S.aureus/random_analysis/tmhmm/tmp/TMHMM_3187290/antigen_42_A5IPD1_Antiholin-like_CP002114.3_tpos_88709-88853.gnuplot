...
set key below
set title "TMHMM posterior probabilities for antigen_42|A5IPD1|Antiholin-like|CP002114.3|tpos:88709-88853"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_3187290/antigen_42_A5IPD1_Antiholin-like_CP002114.3_tpos_88709-88853.eps"
plot "./TMHMM_3187290/antigen_42_A5IPD1_Antiholin-like_CP002114.3_tpos_88709-88853.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
