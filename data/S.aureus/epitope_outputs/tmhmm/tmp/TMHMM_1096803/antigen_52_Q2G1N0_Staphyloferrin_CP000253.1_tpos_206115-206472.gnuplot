...
set arrow from 329,1.09 to 351,1.09 nohead lt 1 lw 40
set arrow from 352,1.11 to 358,1.11 nohead lt 4 lw 10
set key below
set title "TMHMM posterior probabilities for antigen_52|Q2G1N0|Staphyloferrin|CP000253.1|tpos:206115-206472"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_1096803/antigen_52_Q2G1N0_Staphyloferrin_CP000253.1_tpos_206115-206472.eps"
plot "./TMHMM_1096803/antigen_52_Q2G1N0_Staphyloferrin_CP000253.1_tpos_206115-206472.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
