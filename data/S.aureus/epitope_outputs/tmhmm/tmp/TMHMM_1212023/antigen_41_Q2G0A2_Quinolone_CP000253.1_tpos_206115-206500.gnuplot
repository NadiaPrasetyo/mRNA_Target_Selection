...
set key below
set title "TMHMM posterior probabilities for antigen_41|Q2G0A2|Quinolone|CP000253.1|tpos:206115-206500"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_1212023/antigen_41_Q2G0A2_Quinolone_CP000253.1_tpos_206115-206500.eps"
plot "./TMHMM_1212023/antigen_41_Q2G0A2_Quinolone_CP000253.1_tpos_206115-206500.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
