...
set key below
set title "TMHMM posterior probabilities for antigen_42|Q2G0B3|ABC|BA000018.3|tpos:226778-227319"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_1096793/antigen_42_Q2G0B3_ABC_BA000018.3_tpos_226778-227319.eps"
plot "./TMHMM_1096793/antigen_42_Q2G0B3_ABC_BA000018.3_tpos_226778-227319.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
