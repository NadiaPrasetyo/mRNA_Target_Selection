...
def main():
    ...
    parser.add_argument("--tools", nargs="+", choices=VALID_TOOLS, default=[tool for tool in VALID_TOOLS if tool != "MAFFT"], help="List of tools to run (default: all tools except MAFFT)")
